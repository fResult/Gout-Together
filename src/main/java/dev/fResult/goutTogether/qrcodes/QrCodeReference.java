...
public record QrCodeReference(
    @Id Integer id, Integer bookingId, String content, QrCodeStatus status) {
  public static QrCodeReference of(
      Integer id, Integer bookingId, String content, QrCodeStatus status) {
