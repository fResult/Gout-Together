...
class StringUtilTest {
  @Test
  void whenPluralizeInputIsNullOrEmpty_thenReturnInputItself() {
    // Arrange
  ...
  @Test
  void whenPluralizeInputEndsWithY_thenReturnInputWithoutYAndWithIes() {
    // Arrange
    var input1 = "party";
  ...
  @Test
  void whenPluralizeInputEndsWithSOrShOrChOrXOrZ_thenReturnInputWithEs() {
    // Arrange
    var input1 = "bus";
  ...
  @Test
  void whenPluralizeInput_thenAddS() {
    // Arrange
    var input1 = "car";
